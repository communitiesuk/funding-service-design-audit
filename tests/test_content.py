...
from tests.route_testing_conf import example_routes_and_test_content
...
class TestContentWithChrome:
    ...
    def test_example_routes_content(self, client):
        """
        ...
        for (
            route_rel,
            content_dict,
        ) in example_routes_and_test_content.items():
